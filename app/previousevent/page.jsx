...
const fourofourpage = () => {
  return (
    <>
      <div className="h-[100vh] w-[100%] grid grid-cols-1 justify-center items-center coveragebg">
        <h1 className="justify-self-center text-4xl lg:text-6xl m-[10%] text-[#eeeeee] ">
